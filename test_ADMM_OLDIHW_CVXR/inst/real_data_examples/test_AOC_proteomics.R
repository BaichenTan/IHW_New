...
time_admm <- system.time(ihw_res_admm <- ihw(proteomics_df$pvalue,proteomics_df$X..peptides, alpha = 0.1, nbins=4, 
                                             nfolds=5L, lambdas=seq(0,3,length=20)))[1]

time_old <- system.time(ihw_res_old <- IHWold:::ihw(proteomics_df$pvalue,proteomics_df$X..peptides, alpha = 0.1, nbins=4, 
                                             nfolds=5L, lambdas=seq(0,3,length=20)))[1]
